# Generated by Django 2.1.13 on 2020-06-08 16:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2020, 6, 8, 16, 2, 43, 243114, tzinfo=utc), verbose_name='添加时间')),
            ],
            options={
                'db_table': 'Address',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2020, 6, 8, 16, 2, 43, 241113, tzinfo=utc), verbose_name='添加时间')),
            ],
            options={
                'db_table': 'Category',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2020, 6, 8, 16, 2, 43, 241113, tzinfo=utc), verbose_name='加入时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2020, 6, 8, 16, 2, 43, 242113, tzinfo=utc), verbose_name='添加时间')),
            ],
            options={
                'db_table': 'Order',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2020, 6, 8, 16, 2, 43, 244113, tzinfo=utc), verbose_name='添加时间')),
            ],
            options={
                'db_table': 'Profile',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(max_length=16, verbose_name='手机号')),
                ('add_time', models.DateTimeField(default=datetime.datetime(2020, 6, 8, 16, 2, 43, 240113, tzinfo=utc), verbose_name='添加时间')),
            ],
            options={
                'db_table': 'User',
            },
